...
class AgencyRepositoryIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repo = $this->app->make(AgencyRepository::class);
        $this->originalArray = [
            'id' => '1',
		'agency_id' => 'laravel',
		'agency_name' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Agency\Agency');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('agencies', $this->editedArray);
    }
